...
Structure: See data/, notebooks/, src/, results/, figures/, docs/ (no raw large datasets in repo).
How to run: See environment.yml and Dockerfile. Use seeds [42,101,2025,7,99].
